...
public class MySqlGameDAO implements GameDAO {
    ...
    public boolean removePlayer(int gameId, String username, String role) throws Exception{
        if (!exists(gameId)) {
            throw new ResponseException(String.format("Error: Game %s does not exist", gameId));
        }
